...
/* ::base.html.twig */
class __TwigTemplate_be5209feac9f6b83204900f1e2e35d6cddfb018059d1ed42a7812d8b256d3404 extends Twig_Template
{
...
";
    ...
    {
        return array (  666 => 123,  643 => 39,  630 => 29,  626 => 28,  614 => 19,  609 => 17,  605 => 15,  596 => 14,  584 => 12,  579 => 10,  574 => 9,  565 => 8,  547 => 5,  155 => 136,  150 => 134,  138 => 124,  136 => 123,  95 => 84,  91 => 82,  88 => 81,  84 => 79,  82 => 78,  76 => 75,  55 => 59,  46 => 52,  43 => 14,  41 => 8,  35 => 5,  29 => 1,);
    }
...
{% endblock %}
    ...
    <div class=\"header\" id=\"head\">
        <div class=\"header-top\">
                <div class=\"container\">
            <div class=\"logo\">
                <a href=\"index.html{{ path('blogger_blog_list')}}\"><img src=\"{{ asset('images/logo.png') }}\"></a><!--Put your logo here-->
                </div>
                <div class=\"top-menu\">
                    <span class=\"menu\"> </span>
                    <!--Menu-->
                                    ...
                                    <li><a href=\"#testimonial\" class=\"scroll\">Quotes</a></li>
                                        <li><a href=\"#team\" class=\"scroll\">John Snow</a></li>
                                            <li><a href=\"#kill-now\" class=\"scroll\">Family</a></li>
                                                     <li><a href=\"#contact\" class=\"scroll\">contact</a></li>
                -->
                                <li><a href=\"{{ path('blogger_blog_list')}}\" class=\"active\" class=\"scroll\">Inicio</a></li>
                                <li><a href=\"#\" class=\"active\" class=\"scroll\">Sobre mi</a></li>
                                <li><a href=\"#\" class=\"active\" class=\"scroll\">Contacto</a></li>
                                {% if not is_granted('ROLE_ADMIN') %}
                                    <li><a href=\"#\" class=\"active\" class=\"scroll\">Entrar</a></li>
                                {% endif %}
                                {% if is_granted('ROLE_ADMIN') %}
                                    <li><a href=\"#\" class=\"active\" class=\"scroll\">Salir</a></li>
                                {% endif %}
                        </ul>
                        <!--End Menu-->
                    </div>
...
", "::base.html.twig", "C:\\xampp\\htdocs\\GoT\\app/Resources\\views/base.html.twig");
    }
}
